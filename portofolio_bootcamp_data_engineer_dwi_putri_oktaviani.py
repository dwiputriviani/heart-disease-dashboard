...
if menu == "Overview":
    ...
    st.markdown(
        "Dataset dibagi menjadi data latih dan data uji dengan proporsi 80% dan 20%. "
        "Pembagian ini bertujuan agar model dilatih menggunakan sebagian besar data "
        "dan dievaluasi menggunakan data yang belum pernah dilihat sebelumnya."
    )
...
# =========================
    ...
    for i, feature in enumerate(feature_names):
        ...
        # Float dengan 1 desimal & step 0.5
        else:
            with col:
                input_data[feature] = st.number_input(
                    feature,
